                ...
                {[
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-lg flex-1 text-sm font-medium transition-colors ${activeTab === tab.id
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${monitoringSettings.websiteChanges ? 'bg-blue-600' : 'bg-gray-200'
                                        }`}
                                >
                                    <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${monitoringSettings.websiteChanges ? 'translate-x-6' : 'translate-x-1'
                                        }`} />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${monitoringSettings.fundingRounds ? 'bg-blue-600' : 'bg-gray-200'
                                        }`}
                                >
                                    <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${monitoringSettings.fundingRounds ? 'translate-x-6' : 'translate-x-1'
                                        }`} />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${monitoringSettings.leadershipChanges ? 'bg-blue-600' : 'bg-gray-200'
                                        }`}
                                >
                                    <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${monitoringSettings.leadershipChanges ? 'translate-x-6' : 'translate-x-1'
                                        }`} />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${monitoringSettings.pressReleases ? 'bg-blue-600' : 'bg-gray-200'
                                        }`}
                                >
                                    <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${monitoringSettings.pressReleases ? 'translate-x-6' : 'translate-x-1'
                                        }`} />
                                </button>
                            </div>
