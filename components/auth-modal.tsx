                ...
                {currentStep === 'signin' && (
                    <div className="space-y-6">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full py-3 bg-gray-800 border border-gray-700 text-white rounded-lg hover:bg-gray-700 disabled:bg-gray-600 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                        >
                            {isLoading ? (
