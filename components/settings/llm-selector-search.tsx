...
interface LLMSelectorSearchProps {
  value: string[]
...
export function LLMSelectorSearch({ value, onChange }: LLMSelectorSearchProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">LLMs for Search</CardTitle>
      </CardHeader>
