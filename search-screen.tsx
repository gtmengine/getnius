...
const SearchScreen: React.FC<SearchScreenProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {/* Search Categories and CSV Button Container */}
      ...
      <div className="space-y-4">
        ...
        {/* Show reference links only if no CSV queries */}
        ...
        {searchQuery && searchQuery.length > 3 && csvSearchQueries.length === 0 && (
      ...
      {/* Search Examples - only show if no CSV queries */}
      {showExamples && csvSearchQueries.length === 0 && memoizedSearchExamples}
